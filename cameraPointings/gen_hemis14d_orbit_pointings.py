...
pntg_ind = 0
firstNorthPoint = [[90., 0.], [90.-fov, 0.], [90.-2*fov, 0.], [90.-3*fov, 0.]]
firstSouthPoint = [[-90., 0.], [-90.+fov, 0.], [-90.+2*fov, 0.], [-90.+3*fov, 0.]]

for pntg_ind, pointing in enumerate(pointingCoords):
    if pntg_ind == 0:
        pointingCoords[pntg_ind] = firstNorthPoint
    if pntg_ind == 1:
        pointingCoords[pntg_ind] = firstSouthPoint
    if pntg_ind != 0 and pntg_ind != 1:
        pointingCoords[pntg_ind] = pointingCoords[pntg_ind-2] + singleLongRot
