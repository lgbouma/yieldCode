PRO main
  ...
  'temp.fits', $; output file name (w/ fits ext). Nb: fits files dont overwrite
  ...
  fCamCoordPri='../cameraPointings/shemi_nhemi_coord.dat', $ ;where cams pnt for primary mission.
  fCamCoordExt='../cameraPointings/nhemi_coord.dat', $ ;cam coords for ext mission. '' if no ext.
  psPriFile='../../preProcessing/sTIC-selection/shemi_nhemi/shemi_nhemi.sav', $ ; primary PSs
  psExtFile='../../preProcessing/sTIC-selection/shemi_nhemi_nhemi/shemi_nhemi_nhemi.sav', $
