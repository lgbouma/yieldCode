PRO main
  ...
  tile_wrapper, '../../outStarLib/', fnums, $
	'temp.fits', $; output file name. Nb: fits files dont overwrite
  n_trial=2, $	; number of trials (10 good for reasonable statistics)
  ...
  psFile='sTIC-eq1-teffCut.sav', $  ;selected postage stamps from preprocessing
