PRO main
  ...
  tile_wrapper, '../../trilegal/', fnums, $
    'astseis-ps-trueTar.fits', $; output file name. Nb: fits files dont overwrite
    ...
    fTilesCounts='../cameraPointings/ns_nominal_tilesCounts.sav', $ ;pntgStruct (tileNum, coord, nPntg)
    ...
    asteroseisCalc=1 ; are you running asteroseismic yield estimates for subgiants?
END
