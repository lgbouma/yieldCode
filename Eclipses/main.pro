PRO main
  ...
  '160819_198M_shemi_nhemi_nhemi_t10.fits', $; output file name (w/ fits ext). Nb: fits files dont overwrite
  ...
  ffiPriFile='../../preProcessing/sTIC-selection/shemi_nhemi_nhemi_4Morb/shemi_nhemi_198M.sav', $ ; primary FFIs (pseudo-FFIs; drawn from 3.8million)
  psExtFile='../../preProcessing/sTIC-selection/shemi_nhemi_nhemi_4Morb/shemi_nhemi_nhemi_200k.sav', $
            $ ; If primary only, leave as ''
  ffiExtFile='../../preProcessing/sTIC-selection/shemi_nhemi_nhemi_4Morb/shemi_nhemi_nhemi_198M.sav', $
            $ ; If primary only, leave as ''
