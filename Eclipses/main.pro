PRO main
  ...
  'shemi_nhemi_npole_4Morb.fits', $; output file name (w/ fits ext). Nb: fits files dont overwrite
  ...
  fCamCoordExt='../cameraPointings/npole_orbits.dat', $ ;cam coords for ext mission. '' if no ext.
  psPriFile='../../preProcessing/sTIC-selection/shemi_nhemi_npole_4Morb/shemi_nhemi_200k.sav', $ ; primary PSs
  psExtFile='../../preProcessing/sTIC-selection/shemi_nhemi_npole_4Morb/shemi_nhemi_npole_200k.sav', $
