PRO eclipcompstruct__define

  eclip = {eclipcompstruct,  $
	    coord: {coordstruct}, $
	    ...
	    f: 0.0, $ ; True anomaly
	    mult: 0., $ ; # other planets in system
	    tmult: 0., $ ; # other transiting planets in system
	    pr: -1., $ ; Period ratio for multi
		...
		compPlaInd: 0, $ ; gets relevant indices
		isTransiting: 0 $ ; 1 if yes
		}
end
